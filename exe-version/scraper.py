...
def check_price():
  ...
  with open(r'C:\Users\andre\OneDrive - Syddansk Erhvervsskole\GitHub\Price-Checker\exe-version\wanted_price.txt', 'r') as wp_file:
    wanted_price = int(wp_file.read())
...
def send_email(title, price):
  ...
  with open(r'C:\Users\andre\OneDrive - Syddansk Erhvervsskole\GitHub\Price-Checker\exe-version\key.key', 'r') as key:
